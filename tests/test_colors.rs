...
fn encode_cl_fg() {
    ...
    assert_eq!(
        esc::FG_DEFAULT,
        colors::encode_cl_fg(colors::ColorFG::Default)
    );
...
fn encode_cl_bg() {
    ...
    assert_eq!(
        esc::BG_DEFAULT,
        colors::encode_cl_bg(colors::ColorBG::Default)
    );
...
fn transcode_cl_bg_2_fg() {
    ...
    assert_eq!(
        esc::FG_WHITE_INTENSE,
        colors::transcode_cl_bg_2_fg(esc::BG_WHITE_INTENSE)
    );
    assert_eq!(
        esc::FG_SKY_BLUE,
...
fn intensify_cl_fg() {
    ...
    assert_eq!(
        ...
        colors::intensify_cl_fg(colors::ColorFG::Inherit)
    );
    assert_eq!(
        colors::ColorFG::WhiteIntense,
        colors::intensify_cl_fg(colors::ColorFG::Default)
    );

    // test correct values
    assert_eq!(
        colors::ColorFG::WhiteIntense,
        colors::intensify_cl_fg(colors::ColorFG::White)
    );
    assert_eq!(
        colors::ColorFG::MagentaIntense,
        colors::intensify_cl_fg(colors::ColorFG::Magenta)
    );

    // try to intensify intense color
    assert_eq!(
        colors::ColorFG::MagentaIntense,
        colors::intensify_cl_fg(colors::ColorFG::MagentaIntense)
    );
}
...
fn intensify_cl_bg() {
    ...
    assert_eq!(
        ...
        colors::intensify_cl_bg(colors::ColorBG::Inherit)
    );
    assert_eq!(
        colors::ColorBG::WhiteIntense,
        colors::intensify_cl_bg(colors::ColorBG::Default)
    );

    // test correct values
    assert_eq!(
        colors::ColorBG::WhiteIntense,
        colors::intensify_cl_bg(colors::ColorBG::White)
    );
    assert_eq!(
        colors::ColorBG::MagentaIntense,
        colors::intensify_cl_bg(colors::ColorBG::Magenta)
    );

    // try to intensify intense color
    assert_eq!(
        colors::ColorBG::MagentaIntense,
        colors::intensify_cl_bg(colors::ColorBG::MagentaIntense)
    );
}
